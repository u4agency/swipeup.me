            ...
            new UserBadge($accessToken->getToken(), function () use ($accessToken, $client) {
                ...
                if ($this->security->getUser()) {
                    ...
                    if (!$existingUser) {
                        ...
                        $this->newsletterRepository->findOneBy(['email' => $existingUser->getEmail()]) ?: (new NewNewsletter($existingUser->getEmail(), $this->entityManager, "app_register (Facebook OAuth2)"));
