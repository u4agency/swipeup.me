...
//        $this->setSeoContent($this->getContent());
    }
    ...
    {
        return ($this->seoContent ? strip_tags($this->seoContent) : substr(strip_tags($this->content), 0, 246) . '...');
    }

    public function setSeoContent(?string $seoContent): self
    {
